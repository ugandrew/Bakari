...
namespace Bakari.Controllers
{
    public class TransanctionsController : Controller
    {
        ...
        {
            var transanctions = _context.Transanction.OrderByDescending(s => s.Date);
            if (transanctions != null)
            {
                ViewData["Balance"] = transanctions.Sum(t => t.Type == TransanctionType.CashIn ? t.Amount : -t.Amount);
            ...
            else
            {
                ...
                return View(await transanctions.ToListAsync());
            ...
            {
                ViewData["TypeId"] = new SelectList(_context.Transanction, "TransanctionType", "Type");
                return View();
            }
